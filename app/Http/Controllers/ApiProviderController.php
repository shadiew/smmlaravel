...
//        dd($currencyData);
    ...
    public function getApiServices(Request $request)
    {
        ...
        // dd(collect($apiServiceLists)->where('refill',1));
    ...
    public function import(Request $request)
    {
        ...
        if ($existService != 1):
            ...
            $service->price = ($req['rate'] + $increased_price) * $provider->convention_rate;
    ...
    public function importMulti(Request $request)
    {
        ...
        if($request->import_quantity == 'selectItem'){
            $getService = explode(',', $request->selectService);
       ...
       // $apiServicesData = collect($apiServicesData)->where('refill',1)->values();
        ...
        foreach ($apiServicesData as $apiService):
            ...
            if ($existService != 1):
               ...
               $service->price = ($apiService->rate + $increased_price)*$provider->convention_rate;
